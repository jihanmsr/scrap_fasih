"""
UPDATE 29 AGUSTUS 2026 - Master Script
================================================
Mengupdate seluruh menu dashboard secara komprehensif dari folder update_29/:
1. [PROGRES PETUGAS]  2 file sqllab_rekap_progress_petugas_20260829T*.csv
                      -> fast_petugas_progress.js + petugas_region_map.js
                      -> fast_petugas_all_2026-08-29.csv -> fast_petugas_history.js
                      -> Rekap Progress Petugas 29_08.xlsx
2. [REKON SBR/UTP]    2 file sqllab_rekap_sbr_utp_keluarga_20260829T*.csv
                      -> Rekap SBR, UTP, Keluarga_20260829.xlsx
                      -> Laporan_Rekap_KabKot_SBR_UTP_Keluarga_29_08.xlsx
                      -> rekon_data.js
3. [SLS OPEN]         Progress Petugas + sqllab_rekap_jumlah_sub_sls_belum_dikunjungi_20260829T125320.csv
...
UPDATE_DIR = os.path.join(BASE_DIR, 'update_29')

# File paths in update_29
F_PROG_1 = os.path.join(UPDATE_DIR, 'sqllab_rekap_progress_petugas_20260829T125242.csv')
F_PROG_2 = os.path.join(UPDATE_DIR, 'sqllab_rekap_progress_petugas_20260829T125253.csv')

F_REKON_1 = os.path.join(UPDATE_DIR, 'sqllab_rekap_sbr_utp_keluarga_20260829T125221.csv')
F_REKON_2 = os.path.join(UPDATE_DIR, 'sqllab_rekap_sbr_utp_keluarga_20260829T125227.csv')

F_SUBSLS  = os.path.join(UPDATE_DIR, 'sqllab_rekap_jumlah_sub_sls_belum_dikunjungi_20260829T125320.csv')
...
def update_progres_petugas():
    print("\n" + "="*60)
    print("  [1/3] UPDATE MENU PROGRES PETUGAS & HISTORY (29 AGUSTUS)")
    print("="*60)
    ...
    # Save to Excel
    out_xlsx = os.path.join(BASE_DIR, 'Rekap Progress Petugas 29_08.xlsx')
    try:
    ...
    # ── B. fast_petugas_all_2026-08-29.csv & fast_petugas_history.js ────────────
    ...
    csv_29 = os.path.join(BASE_DIR, 'fast_petugas_all_2026-08-29.csv')
    combined.to_csv(csv_29, index=False)
    combined.to_csv(os.path.join(BASE_DIR, 'fast_petugas_all.csv'), index=False)
    print(f"    OK fast_petugas_all_2026-08-29.csv dibuat ({len(combined):,} baris)")

    # Rebuild history
    import subprocess
    subprocess.run([sys.executable, os.path.join(BASE_DIR, 'rebuild_history.py')], check=True)
    print("    OK fast_petugas_history.js diperbarui (sampai 29 AGUSTUS)")
...
def update_rekon_sbr():
    print("\n" + "="*60)
    print("  [2/3] UPDATE MENU REKON / SBR-UTP-KELUARGA (TABULASI 29 AGUSTUS)")
    print("="*60)
    ...
    # Save to Excel
    out_rekon_xlsx = os.path.join(BASE_DIR, 'Rekap SBR, UTP, Keluarga_20260829.xlsx')
    df_real.to_excel(out_rekon_xlsx, index=False)
    out_rekon_xlsx_alt = os.path.join(BASE_DIR, 'Rekap SBR, UTP, Keluarga_29_08.xlsx')
    ...
    out_kabkot = os.path.join(BASE_DIR, 'Laporan_Rekap_KabKot_SBR_UTP_Keluarga_29_08.xlsx')
...
def main():
    print("\n" + "=" * 60)
    print("  UPDATE DASHBOARD 29 AGUSTUS 2026")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("  SEMUA DATA BERHASIL DIUPDATE PER 29 AGUSTUS 2026!")
    print("=" * 60 + "\n")
