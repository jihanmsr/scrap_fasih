"""
UPDATE 8 SEPTEMBER 2026 - Master Script
================================================
Mengupdate seluruh menu dashboard secara komprehensif dari folder update_8/:
...
UPDATE_DIR = os.path.join(BASE_DIR, 'update_8')

# File paths in update_8
F_PROGRES = os.path.join(BASE_DIR, os.path.join(UPDATE_DIR, 'rekap_progress_petugas (7).xlsx'))
F_REKON   = os.path.join(UPDATE_DIR, 'rekap_sbr_utp_keluarga (7).xlsx')
...
def update_progres_petugas():
    print("\n" + "="*60)
    print("  [1/3] UPDATE MENU PROGRES PETUGAS & HISTORY (8 SEPTEMBER)")
    print("="*60)
    ...
    # Save to Excel
    out_xlsx = os.path.join(BASE_DIR, os.path.join(UPDATE_DIR, 'rekap_progress_petugas (7).xlsx'))
    try:
    ...
    csv_01 = os.path.join(BASE_DIR, 'fast_petugas_all_2026-09-08.csv')
    ...
    print("    OK fast_petugas_history.js diperbarui (sampai 8 SEPTEMBER)")
...
def update_rekon_sbr():
    print("\n" + "="*60)
    print("  [2/3] UPDATE MENU REKON / SBR-UTP-KELUARGA (TABULASI 8 SEPTEMBER)")
    print("="*60)
    ...
    # Save to Excel
    out_rekon_xlsx = os.path.join(BASE_DIR, 'Rekap SBR, UTP, Keluarga_20260908.xlsx')
    ...
    out_kabkot = os.path.join(BASE_DIR, 'Laporan_Rekap_KabKot_SBR_UTP_Keluarga_08_09.xlsx')
...
def main():
    print("\n" + "=" * 60)
    print("  UPDATE DASHBOARD 8 SEPTEMBER 2026")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("  SEMUA DATA BERHASIL DIUPDATE PER 8 SEPTEMBER 2026!")
    print("=" * 60 + "\n")
