...
async def main():
    async with async_playwright() as p:
        ...
        try:
            ...
            print("Navigation done. Waiting 20 seconds for login/table loading and API capture...")
            await asyncio.sleep(20)
        except Exception as e:
            print("Navigation failed:", e)

        with open("scratch/captured_actual.json", "w", encoding="utf-8") as f:
            json.dump(captured, f, indent=2, ensure_ascii=False)
            
        print(f"Done! Captured {len(captured)} requests. Saved to scratch/captured_actual.json")
