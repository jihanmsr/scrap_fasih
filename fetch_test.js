...
const options = {
  ...
  headers: {
    ...
    'x-xsrf-token': '17f3c068-ef6a-40f4-b1a8-352fbb377bd3',
...
const req = https.request(options, (res) => {
  ...
  res.on('end', () => {
    const j = JSON.parse(body);  console.log('Total Hit:', j.totalHit);
  });
});
