...
from scrape_assign import scrape_assign
from report_progress_petugas import main as generate_petugas_report
...
async def run_all():
    ...
    print("[1/5] Menarik data sinkronisasi Superset...")
    try:
    ...
    print("[2/5] Menghasilkan laporan utama dashboard & statistik harian...")
    try:
    ...
    print("[3/5] Menarik status pengiriman email Usaha Besar (UB)...")
    try:
    ...
    print("[4/5] Menarik rincian target granular tingkat SLS...")
    try:
    ...
    # 5. Scrape Alokasi Petugas
    print("[5/5] Menarik data alokasi penugasan petugas...")
    try:
        await scrape_assign()
        print("-> Sukses memperbarui data alokasi petugas.\n")
    except Exception as e:
        print(f"-> [ERROR] Gagal menarik data alokasi petugas: {e}\n")

    # 6. Generate Laporan Excel Petugas
    print("[6/6] Menghasilkan laporan Excel progres tiap petugas...")
    try:
        generate_petugas_report()
        print("-> Sukses memperbarui laporan Excel petugas.\n")
    except Exception as e:
        print(f"-> [ERROR] Gagal menghasilkan laporan Excel petugas: {e}\n")
