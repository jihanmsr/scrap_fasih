        ...
        async def do_fetch():
            async def fetch_dynamic_node(r3, r4, r5):
                ...
                while True:
                    ...
                    payload_dt = {
                        "start": start, "length": length, "columns": columns_payload, "order": [],
                    ...
                    for attempt in range(4):
                        try:
                            ...
                            # DEBUG PRINT
                            if res_dt:
                                print(f"      [DEBUG-RES] {k['kec_name']} -> searchData len: {len(res_dt.get('searchData', []))}, totalHit: {res_dt.get('totalHit', 'N/A')}")
